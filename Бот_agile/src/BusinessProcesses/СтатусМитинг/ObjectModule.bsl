...
Процедура ДействиеЧтоДелалВчераПриСозданииЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, Отказ)
	...
	ИнтеграцияСМессенджерами.TelegramSendMessage(Бот.Токен , "Что делали вчера?", Пользователь.chat_id);
	
КонецПроцедуры

Процедура ДействиеЧтоБудешьДелатьСегодняПриСозданииЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, Отказ)
	
	ИнтеграцияСМессенджерами.TelegramSendMessage(Бот.Токен , "Что будете делать сегодня?", Пользователь.chat_id);
	
КонецПроцедуры

Процедура ДействиеКакиеПроблемыПриСозданииЗадач(ТочкаМаршрутаБизнесПроцесса, ФормируемыеЗадачи, Отказ)

	ИнтеграцияСМессенджерами.TelegramSendMessage(Бот.Токен , "Какие были проблемы?", Пользователь.chat_id);

КонецПроцедуры

Процедура ЗавершениеПриЗавершении(ТочкаМаршрутаБизнесПроцесса, Отказ)

	ИнтеграцияСМессенджерами.TelegramSendMessage(Бот.Токен , "Спасибо, так и запишем.", Пользователь.chat_id);
...
Процедура ОтправитьРезультатРуководителю()
	...
	|		И НЕ (Пользователи.НеПолучатьУведомления)
	...
	Пока Выборкаchat_id.Следующий() Цикл
		...
		ИнтеграцияСМессенджерами.TelegramSendMessage(Бот.Токен , СтрокаСообщения, Выборкаchat_id.chat_id);
