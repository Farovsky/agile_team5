...
Процедура ПриКомпоновкеРезультата(ДокументРезультат, ДанныеРасшифровки, СтандартнаяОбработка)
	...
	НенулевойВводВывод = ирОбщий.НайтиЭлементКоллекцииЛкс(КонечнаяНастройка.Отбор.Элементы, "Представление", "Ненулевой ввод/вывод");
	...
	КонецЕсли; 
	ГруппаОтбора = ирОбщий.НайтиЭлементКоллекцииЛкс(КонечнаяНастройка.Отбор.Элементы, "Представление", "Не содержит служебных таблиц 1С");
	...
	ВыбранноеПолеПланЗапроса = ирОбщий.НайтиЭлементКоллекцииЛкс(ВсеВыбранныеПоля, "Поле", Новый ПолеКомпоновкиДанных("query_plan"));
	...
	ВыбранноеПолеТаблицыМетаданных = ирОбщий.НайтиЭлементКоллекцииЛкс(ВсеВыбранныеПоля, "Поле", Новый ПолеКомпоновкиДанных("ТаблицыМетаданных"));
	ВыбранноеПолеТекстЗапросаМета = ирОбщий.НайтиЭлементКоллекцииЛкс(ВсеВыбранныеПоля, "Поле", Новый ПолеКомпоновкиДанных("ТекстЗапросаМета"));
